...
logging.basicConfig(filename="ecommerce_amazon.log",filemode = 'w', level=logging.INFO, format='%(asctime)s %(message)s', datefmt='%d/%m/%Y %H:%M:%S')
logging.info('Execution starts Here.')

#Providing the URL
BASE_URL = "https://www.amazon.in"
#Providing mail id
EMAIL_ID = "rishiroyal666@gmail.com"
...
#############################################################################################################
    ...
    def signup(self):
        ...
        mobile_number.send_keys("9347323300")
        time.sleep(3)
        ...
        mail.send_keys("rishirs666@gmail.com")
        time.sleep(3)
...
#############################################################################################################
    ...
    def valid_email_password_signin(self):
        ...
        email.send_keys("rishiroyal666@gmail.com")
        time.sleep(3)
...
#############################################################################################################
    ...
    def forgot_password(self):
        ...
        new_pswd = "rishitha999"
        retype_pswd = "rishitha999"
...
# Script name               :       ecommerce_amazon.py
# Script version            :       1.0
